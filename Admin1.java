	   ...
	   //ending the call
		int n;
		 Scanner sc=new Scanner(System.in);
			...
			statement.executeUpdate("INSERT INTO admin(`product_id`,`Product_name`, `Quantity`, `price`) VALUES('"+productid+"','"+productname+"','"+quantity+"','"+price+"')");
			statement.executeUpdate("INSERT INTO agent(`product_id`,`Product_name`, `price`) VALUES('"+productid+"','"+productname+"','"+price+"')");
